...
<div class="modal-dialog" role="document" style="width: 756px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Istorija podrške za odjel</h5>
  ...
  <?php      
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Zatvoreno</button> 
      </div>
 	 </form>
    </div>
  </div>