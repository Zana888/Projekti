...
<div id="content">
		<div id="displayCategories" class="panel panel-default">
        		<div class="panel-heading">System Podešavanja</div>
				...
				<form class="form" method="post">
				    ...
				    <label for="version" class="col-sm-3 control-label">System Verzija</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="authentication" class="col-sm-3 control-label">Autentifikacija</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="email" class="col-sm-3 control-label">Notifikacija Email-a</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				    <label for="language" class="col-sm-3 control-label">Jezik</label>
				      <div class="col-sm-8">
					...
					<div class="form-group">
				    <label for="siteurl" class="col-sm-3 control-label">Sajt url</label>
				      <div class="col-sm-8">
				  ...
				  <div class="form-group">
				 	 ...
				 	 <button class="btn btn-success" name="saveSettings" type="submit">Sačuvaj</button>
				      </div>
				  </div>
